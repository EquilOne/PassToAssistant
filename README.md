...
> **Not just for assistants.** You can use this with any Gmail label. Set it up for a team member, a shared mailbox, a project label — anything where you want newly-labeled threads to auto-surface as unread.
